...
<form action="timelineUpdate" method="post">
	...
	<div class="container">
		...
		<div class="card-body" align="center">
			<table>
				<tr>
					<th>내가 고른 키워드들 :</th><td><input type="text" id="traits_Selected" name="traits_Selected" readonly="readonly"  value="${timelineVO.traits_Selected}" style="width: 100%;"></td>
				</tr>
				<tr>
					<th>에피소드 제목 : </th><td><input type="text" name="episode_Title" value="${timelineVO.episode_Title}" style="width: 100%;" required="required"></td>
				</tr>
				<tr>
					<th>에피소드 내용 : </th><td><textarea rows="10" cols="120" name="episode_Content" required="required" required="required" >${timelineVO.episode_Content}</textarea></td>
				</tr>
				<tr>
