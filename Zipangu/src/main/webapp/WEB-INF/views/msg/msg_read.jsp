...
// 					str += '<c:if test="${sessionScope.userID=='+data[i].mentor_id+'}">';
// 				    str += '<li class="person" data-chat="person'+data[i].msg_num+'">';	
// 				    str += '<span class="name">'+data[i].mentee_id+'</span>';'
// 				    str += '</li>';
// 				    str += '</c:if>';
// 				    str += '<c:if test="${sessionScope.userID=='+data[i].mentee_id+'}">;
// 					str += '<li class="person" data-chat="person${list.msg_num}">	;
// 					str += '<span class="name">${list.mentor_id}</span>
// 					str += '</li>			
// 					str += '</c:if>
// 					str += ' </a>
...
<div class="wrapper">
    <div class="container">
    	<div class="left">
            ...
            <div id="after_search" hidden="hidden"></div>
