		...
		<div class="container">
			<div class="row fullscreen d-flex align-items-center justify-content-center" style="height: 700px;">
				<div class="banner_content">
					<h2>
						Zipangu<br> 일본 취직,,도우미,,대충 홍보멘트 하나<br>
					</h2>
					<p>자기 분석 툴을 써서~~~~ 자소서도 쓰고 기업도 추천받고 멘토링도 하고 면접도 보세요~~~~~~ 성향분석부터 시작해보세요 ~~~~ 어쩌고 저쩌고 ~~~~~~~~~~</p>
				...
				<div class="service-2-left">
					...
					<div class="author-lacture">
						...
						<div class="author-title">
							<div class="thumb">
								<img src="${pageContext.request.contextPath}/resources/template_img/about-author.png" alt="">
							</div>
							<div class="a-desc">
								<h6>Marvel Maison</h6>
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-6">
							<div class="left-image">
								<div class="s-img">
									<img class="img-fluid" src="${pageContext.request.contextPath}/resources/template_img/service/service4.jpg" alt="">
								</div>
								<div class="s-img">
									<img class="img-fluid" src="${pageContext.request.contextPath}/resources/template_img/service/service5.jpg" alt="">
								</div>
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-6">
							<div class="right-image">
								<div class="s-img">
									<img class="img-fluid" src="${pageContext.request.contextPath}/resources/template_img/service/service6.jpg" alt="">
								</div>
								<div class="s-img">
									<img class="img-fluid" src="${pageContext.request.contextPath}/resources/template_img/service/service7.jpg" alt="">
								</div>
							</div>
						</div>
					</div>
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
				<div class="single-service">
					...
					<div class="service-details">
						<h5>
							<a href="#">Get to Know Project Estimate?</a>
						</h5>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed eiusmod tempor incididunt labore dolore magna aliqua enim minim veniam quis nostrud. Lorem ipsum dolor sit amet.</p>
					</div>
				</div>
			</div>
			<!-- single service -->
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
				<div class="single-blog">
					...
					<div class="blog-details">
						...
						<h5>
							<a href="#">Addiction When Gambling <br> Becomes A Problem
							</a>
						</h5>
